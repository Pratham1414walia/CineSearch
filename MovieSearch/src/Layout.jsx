  ...
  return (
    ...
    <nav className="navbar">
      ...
      <div className="inline-flex items-center  space-x-3">
          <img src="./film.png" className="FilmLogo" alt="Flowbite Logo" />
  ...
  {/* value={inputSearch} */}
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
            <li>
              <Link to="/" className="block py-2 px-3 text-white bg-blue-700 rounded " aria-current="page">Home</Link>
            </li>
            <li>
              <Link to="about" className="block py-2 px-3 text-gray-900 rounded">About</Link>
            </li>
            <li>
              <Link to="wishlist" className="block py-2 px-3 text-gray-900 rounded">Wishlist</Link>
            </li>
            <li>
              <Link to="contact" className="block py-2 px-3 text-gray-900 rounded">Contact</Link>
            </li>
          </ul>
        </div>
